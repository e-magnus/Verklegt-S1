...
Main:
Bjóða uppá möguleika að:
* Skrá nýja persónu
* Leita í listanum
* Skoða lista

Class:
ComputerScientist - Heldur utan um allar skráningar. (Parent of Sorting)
Sorting - Heldur utan um mismunandi leiðir til að flokka skráingar. 
Search - Fyrir leit í skjölum.
...
(10%) Hópar hafa svigrúm til að bæta við uppgefnar kröfur, einnig er hægt að vinna sér inn stig með sérlega vel útfærðum lausnum.
